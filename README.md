...
<p align="center">
  <a href="https://github.com/subhasishsahugit/subhasish-sahu">
    <img src="https://komarev.com/ghpvc/?username=subhasishsahugit&style=for-the-badge&color=blue" alt="Profile Views" />
  </a>
  <a href="https://github.com/subhasishsahugit?tab=followers">
    <img alt="GitHub followers" src="https://img.shields.io/github/followers/subhasishsahugit?style=for-the-badge&logo=github&color=green">
  </a>
</p>
...
personality: ["Passionate Learner", "Problem Solver", "Team Player", "Self-Motivated"]
open_to: ["Internships", "Collaborations", "Guidance", "Real-World Projects"]
```

> *"A passionate Computer Science Engineering student dedicated to building real-world skills through consistent practice and hands-on learning. Eager to apply technical knowledge to solve meaningful problems and contribute to impactful projects. Always open to new opportunities, feedback, and continuous growth."*
...
### 🔹 Data Analytics (DA) Intern
**IBM SkillsBuild** | Student Ambassador Program | Remote  
📅 *June 2025 - August 2025*

- 📊 Completed intensive training on **Big Data fundamentals** and **Data Analysis using Python**
- 📈 Applied analytical techniques to interpret complex datasets and create meaningful visualizations
- 🎯 **Skills Acquired:** Data Analysis, Python (Pandas, NumPy), Big Data Concepts, Data Visualization

---

### 🔹 Freelance Data Curator
**DesiCrew Solutions Private Limited** | Remote  
📅 *September 2024 - January 2025*

- 🎙️ Specialized in building **high-precision datasets for AI training** with 99%+ accuracy
- 🗣️ Successfully curated and annotated **100+ hours of native Odia audio** with focus on Ganjami dialect
- 📝 Managed entire data lifecycle: recording authentic conversational speech → generating structured JSON transcripts → rigorous Quality Assurance (QA)
- 🤖 Supported development of **ASR (Automatic Speech Recognition)** and **NLP models**
- ✅ Ensured dataset quality through systematic validation and error correction processes

---

### 🔹 Front End Web Development (FEWD) Intern
**IBM SkillsBuild** | CSRBOX Program | Remote  
📅 *June 2024 - August 2024*

- 💻 Completed 6-week intensive technical training on **Front End Web Development**
- 🌐 Built multiple responsive web pages using **HTML5, CSS3, and JavaScript**
- 🎨 Developed skills in **UI Design, Responsive Layouts**, and **Project Management**
- 🚀 **Skills Acquired:** Web Development, UI/UX Design, JavaScript, Project Management
...
![Computer Hardware](https://img.shields.io/badge/Hardware-Maintenance-FF6B6B?style=for-the-badge&logo=windows&logoColor=white)

### 🗣️ Languages
![Odia](https://img.shields.io/badge/Odia-Native-orange?style=for-the-badge)
![Hindi](https://img.shields.io/badge/Hindi-Native-green?style=for-the-badge)
...
<p align="center">
  <a href="https://www.credly.com/users/subhasishsahu">
    <img src="https://img.shields.io/badge/Credly-View_Badges-FF6B00?style=for-the-badge&logo=credly&logoColor=white" alt="Credly Badges" />
  </a>
  <a href="https://huggingface.co/IamAGI">
    <img src="https://img.shields.io/badge/HuggingFace-IamAGI-FFD21E?style=for-the-badge&logo=huggingface&logoColor=black" alt="HuggingFace" />
  </a>
</p>
